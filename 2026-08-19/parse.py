...
class Crawler:
    ...
    def __init__(self):
        ...
        # Collection containing product_id, category, category_id
        self.source_collection = client[
            MONGO_DB
        ][
            MONGO_COLLECTION_DATA
        ]

        # Collection where product details will be stored
    ...
    def start(self):
        """Read product IDs and request product details."""
        ...
        for product in products:
            ...
            try:
                ...
                # Put product ID into PRODUCT_JSON_DATA
    ...
    def parse_item(
        ...
        if attributes:
            ...
            price__base = attrs.get(
                "pricePerBaseUnit",
                ""
            )


            vaule_base = attrs.get(
                "baseContentValue",
                ""
            )
